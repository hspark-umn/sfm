...
struct PoseRefinement {
  PoseRefinement(double u, double v, double X, double Y, double Z,
				 double omega, double px, double py, double k11, double k13, double k22, double k23)
			  : u_(u), v_(v), X_(X), Y_(Y), Z_(Z), omega_(omega), px_(px), py_(py),
			  k11_(k11), k13_(k13), k22_(k22), k23_(k23){}
 ...
 private:
  ...
  const double k11_, k13_, k22_, k23_;
};


void Reprojection_pose(double *camera, double u, double v, double X1, double X2, double X3, double omega, double px, double py, 
